...
tronco = Material(diffuse=color(80, 0, 0), albedo=[0.9, 0.1,0,0], spec=10, texture= Textures('tronco.bmp'))
...
puerta = Material(diffuse=color(80, 0, 0), albedo=[0.9, 0.1,0,0], spec=10, texture= Textures('puerta.bmp'))